            ...
            <div class='fs-form-wrap' id='fs-form-wrap'>
                ...
                <form id='myform' class='fs-form fs-form-full' autocomplete='off' action='../cargando.php' method='POST'>
                    <ol class='fs-fields'>
                        ...
                        <li data-input-trigger>
                            <label class='fs-field-label fs-anim-upper' for='q2' data-info=''>Te llevaremos desde la ideacion de tu proyecto hasta el punto en que puedas vivir de tu negocio</label><br><img src='https://media.giphy.com/media/11s7Ke7jcNxCHS/giphy.gif' alt='startuplife Pregunta 2:' class='fs-anim-upper imagen-pregunta'>
                            <div class='fs-radio-group fs-radio-custom clearfix fs-anim-lower'>
